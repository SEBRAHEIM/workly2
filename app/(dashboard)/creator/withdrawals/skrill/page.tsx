...
export default function SkrillWithdrawalPage() {
        ...
        <div className="min-h-screen bg-[#F3F0E9] p-6 md:p-12">
            <div className="max-w-2xl mx-auto">
                ...
                <div className="mb-10 text-center">
                    <h1 className="text-xl font-black text-[#333333] uppercase tracking-tight mb-8">Withdraw Through Skrill</h1>
                </div>
                ...
                >
                    <div className="mb-8 flex justify-center">
                        <div className="text-4xl font-black italic tracking-tighter text-[#802D69]">Skrill</div>
                    </div>
