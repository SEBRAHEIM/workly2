                ...
                <div className="bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-[#E6E2D6]">
                    ...
                    <div className="relative mb-8">
                        ...
                        <div className="relative flex justify-center text-sm">
                            <span className="px-2 bg-white text-gray-400 font-sans">Or log in with email</span>
                        </div>
                    </div>
                    ...
                    <form action={formAction} className="flex flex-col space-y-4">
                        ...
                        <button
                            type="submit"
                            className="w-full rounded-xl bg-[#3E4C37] px-4 py-3 text-white font-medium hover:bg-[#2e3b29] hover:shadow-lg active:scale-[0.98] transition-all duration-200 ease-in-out mt-2"
                        >
                            Log In
                        </button>
                    </form>
                    ...
                    <div className="mt-8 text-center bg-gray-50 -mx-8 -mb-8 sm:-mx-12 sm:-mb-12 p-6 rounded-b-3xl border-t border-gray-100">
                        <p className="text-sm text-gray-500">
                            ...
                            <Link href="/join" className="text-[#3E4C37] font-semibold hover:underline">
                                Sign up
                            </Link>
                        </p>
                    </div>
