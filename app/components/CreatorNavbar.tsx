        ...
        <>
            <nav className="flex items-center justify-between px-6 py-4 sticky top-0 bg-[#F3F0E9]/80 backdrop-blur-md z-50">
                ...
                <div className="absolute left-1/2 transform -translate-x-1/2">
                    <Link href="/creator" className="text-xl tracking-widest text-[#333333] font-sans uppercase">
                        Workly
                    </Link>
                </div>
                    ...
                    <div className="absolute top-0 left-0 h-full w-[80%] max-w-sm bg-[#F3F0E9] shadow-2xl flex flex-col transform transition-transform duration-300 ease-in-out">
                        ...
                        <div className="flex flex-col items-center pt-16 pb-10 border-b border-[#E6E2D6]">
                            ...
                            <span className="text-xs font-sans text-gray-500 uppercase tracking-widest mt-1">
                                {profile?.role ? `${profile.role} Account` : 'Creator Account'}
                            </span>
                            <div className="flex items-center mt-3 px-3 py-1 bg-white rounded-full border border-[#E6E2D6] shadow-sm">
                                <Star className="w-3 h-3 text-yellow-500 fill-yellow-500 mr-1.5" />
                                <span className="text-xs font-bold text-[#333333] mr-2">{profile?.rating_avg || '0.0'}</span>
                                <span className="text-[10px] text-gray-400 font-medium uppercase tracking-wider border-l border-gray-200 pl-2">
                        ...
                        <div className="flex-1 overflow-y-auto py-8">
                            <div className="px-6 mb-6">
                                <Link
                                    ...
                                    onClick={() => setIsMenuOpen(false)}
                                    className="w-full flex items-center p-2 rounded-xl text-[#333333] hover:text-[#3E4C37] bg-white border border-[#E6E2D6] shadow-sm active:scale-98 transition-all touch-manipulation mb-8"
                                >
                                    <div className="w-8 h-8 rounded-full bg-[#F3F0E9] flex items-center justify-center mr-3 shadow-sm">
                                        <User className="w-4 h-4 text-[#3E4C37]" />
                                    </div>
                                    <span className="font-bold text-[#3E4C37]">My Identity</span>
                                </Link>
