                ...
                <div className="bg-white/80 backdrop-blur-xl rounded-[2.5rem] p-6 md:p-12 shadow-2xl shadow-sky-100/50 border border-sky-100 mx-auto">
                    ...
                    {typeof window !== 'undefined' && new URLSearchParams(window.location.search).get('message') && (
                        <div className="mb-6 bg-sky-50 border border-sky-100 rounded-2xl p-4">
                            <p className="text-[#0EA5E9] text-xs font-bold uppercase tracking-widest text-center">
                    ...
                    <form action={formAction} className="flex flex-col space-y-4">
                        ...
                        <div className="flex justify-end px-2">
                            <Link
                                ...
                                className="text-[10px] font-black text-[#0EA5E9] uppercase tracking-widest hover:underline"
                            >
                                Forgot Password?
                            </Link>
                        </div>
